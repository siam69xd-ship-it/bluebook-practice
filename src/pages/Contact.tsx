    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-[800px] mx-auto px-6 py-16 lg:py-24">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          ...
          <h1 className="text-3xl sm:text-4xl font-semibold tracking-tight text-foreground mb-8">Contact NextPrep</h1>

          <div className="prose prose-slate max-w-none">
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              We welcome questions, feedback, and suggestions from students, educators, and users of the NextPrep platform.
            </p>
            ...
            <div className="border border-border rounded-lg p-6 mb-10">
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <a href="mailto:support@nextprep.org" className="text-foreground hover:underline">support@nextprep.org</a>
              </div>
              <p className="text-sm text-muted-foreground">Response Time: We aim to respond within 24 to 48 hours.</p>
            </div>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 mb-10">
              ...
              <li>General inquiries about NextPrep</li>
            </ul>
            <p className="text-sm text-muted-foreground italic">
              Please note that NextPrep cannot provide personalized admission counseling or score predictions.
            </p>
          </div>
        </motion.div>
      </main>
